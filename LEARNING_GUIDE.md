...
1. 启动应用后登录
2. 进入 **设置** → **模型配置**
3. 选择您使用的供应商（OpenAI、Anthropic 等）
4. 填入 API 密钥和模型名称
5. 测试连接后保存
...
- `script_agent_skill.md` - 剧本生成提示词
- `production_agent_skill.md` - 制作提示词
...
- 📺 [Bilibili 官方教程](https://www.bilibili.com/video/BV1oXD7BqEqJ)
- 📖 [Express.js 官方文档](https://expressjs.com/)
- 🤖 [Vercel AI SDK 文档](https://ai-sdk.dev/)
- 💾 [SQLite 官方网站](https://www.sqlite.org/)
- ⚙️ [TypeScript 官方文档](https://www.typescriptlang.org/)
